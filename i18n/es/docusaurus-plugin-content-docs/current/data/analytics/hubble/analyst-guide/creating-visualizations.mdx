...
import hubble_visualization_demo from "/assets/hubble/hubble-visualizatoin-demo.gif";
import create_data_source from "/assets/hubble/create-data-source.png";
import bq_connector from "/assets/hubble/bq-connector.png";
import add_contract_data from "/assets/hubble/add-contract-data.png";
import create_report from "/assets/hubble/create-report.png";
import select_data_sources from "/assets/hubble/select-data-sources.png";
import add_pie_chart from "/assets/hubble/add-pie-chart.png";
import pie_contract_data from "/assets/hubble/pie-contract-data.png";
import pie_config from "/assets/hubble/pie-config.png";
import pie_chart_durability from "/assets/hubble/pie-chart-durability.png";
import click_add_data from "/assets/hubble/click-add-data.png";
import add_custom_query from "/assets/hubble/add-custom-query.png";
import add_column_chart from "/assets/hubble/add-column-chart.png";
import column_chart_config from "/assets/hubble/column-chart-config.png";
import expired_entry_column_chart from "/assets/hubble/expired-entry-column-chart.png";
import add_quick_filter from "/assets/hubble/add-quick-filter.png";
import filter_contract from "/assets/hubble/filter-contract.png";
import persistent_only from "/assets/hubble/persistent-only.png";
import filtered_report from "/assets/hubble/filtered-report.png";
