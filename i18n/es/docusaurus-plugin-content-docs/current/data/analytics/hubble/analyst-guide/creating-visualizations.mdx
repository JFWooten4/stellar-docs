...
<img src="/assets/hubble/hubble-visualizatoin-demo.gif" width="1000" />
...
<img src="/assets/hubble/create-data-source.png" width="200" />

2. Encuentra y selecciona el `Conector de Google BigQuery`

<img src="/assets/hubble/bq-connector.png" width="300" />
...
<img src="/assets/hubble/add-contract-data.png" width="600" />

### Crear un Nuevo Informe (Tablero)

1. Seleccionar `Crear --> Informe`

<img src="/assets/hubble/create-report.png" width="200" />

2. Añade tus fuentes de datos de arriba

<img src="/assets/hubble/select-data-sources.png" width="300" />

3. Inserta un `Gráfico de Tarta`

<img src="/assets/hubble/add-pie-chart.png" width="200" />

4. Elige `contract_data` como la `Fuente de datos`

<img src="/assets/hubble/pie-contract-data.png" width="300" />

5. Elige `closed_at` como la `Dimensión de Rango de Fechas` y `contract_durability` como la `Dimensión`

<img src="/assets/hubble/pie-config.png" width="300" />
...
<img src="/assets/hubble/pie-chart-durability.png" width="500" />
...
<img src="/assets/hubble/click-add-data.png" width="500" />
...
<img src="/assets/hubble/add-custom-query.png" width="500" />
...
<img src="/assets/hubble/add-column-chart.png" width="200" />
...
<img src="/assets/hubble/column-chart-config.png" width="300" />
