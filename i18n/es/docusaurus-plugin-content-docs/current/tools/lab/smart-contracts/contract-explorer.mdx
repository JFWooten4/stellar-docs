...
![Lab Contract Explorer Contract Info](/assets/lab/contract-explorer/info.png)
...
![Lab Contract Explorer Contract Spec](/assets/lab/contract-explorer/spec.png)
...
![Lab Contract Explorer Source Code](/assets/lab/contract-explorer/source.png)
...
![Lab Contract Explorer Contract Storage](/assets/lab/contract-explorer/storage.png)

### Restaurar Footprint

Las entradas de almacenamiento archivadas pueden restaurarse haciendo clic en el botón `Restore` junto a la entrada.

![Lab Contract Explorer Contract Storage](/assets/lab/contract-explorer/restore.png)
...
![Lab Contract Explorer Build Info](/assets/lab/contract-explorer/build.png)

## Historial de versiones

En esta sección, puedes encontrar el historial de cambios del Wasm.

![Lab Contract Explorer Version History](/assets/lab/contract-explorer/version.png)
...
![Lab Contract Explorer Invoke Contract](/assets/lab/contract-explorer/invoke.gif)
