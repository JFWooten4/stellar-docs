...
![Lab P Gina de Horizon](/assets/lab/horizon/horizon-endpoints.png)
...
![Lab Horizon Ver Docs](/assets/lab/horizon/horizon-view-docs.png)
...
![Lab Horizon Pagos](/assets/lab/horizon/horizon-payments.png)
...
![Lab Horizon Respuesta de Pagos](/assets/lab/horizon/horizon-payments-response.png)
...
![Lab Horizon P Gina de](/assets/lab/horizon/horizon-assets.png)
...
![Lab Horizon P Gina de](/assets/lab/horizon/horizon-assets-usdc.png)

Cuando hago clic en el botón **Enviar**, el punto final `/assets` devuelve los detalles del activo `USDC` en formato `JSON`.

![Lab Horizon P Gina de](/assets/lab/horizon/horizon-assets-usdc-response.png)
...
![Lab Horizon Funci N Compartir](/assets/lab/horizon/horizon-share.png)
...
![Lab Horizon Guardar](/assets/lab/horizon/horizon-save.png)
...
![Lab Horizon Modal](/assets/lab/horizon/horizon-save-modal.png)
