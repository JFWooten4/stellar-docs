...
3. CAP-52 — Smart Contract Host Functionality: Base64 Encoding/Decoding was drafted to introduce encoding/decoding functions for Base64, which is needed by WebAuthN. Considerations discussed in the meeting:
