...
2. The draft proposal lays out the state archival architecture: evicted persistent entries get archived into the Hot/Cold archives, recorded via the Archive State Tree, and exposed through RPC/RestoreOp proofs instead of a separate ESS.
...
3. Ongoing GitHub discussion about safely evicting and later restoring persistent contract state in CAP-57 by archiving it in Stellar’s History Archive and generating cryptographic proofs during preflight, without introducing a new storage system.
...
- [Draft state archival proposal](https://docs.google.com/document/d/1FAs3Yfo-o-gVqccrP29NSG8ysRvdEoyvuL7ywV4ijXI)
- [CAP-57: State Archival Persistent Entry Eviction](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0057.md) ([Discussion: Persistent Entry Eviction](https://github.com/stellar/stellar-protocol/discussions/1480))
