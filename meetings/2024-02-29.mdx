...
1. Tommaso proposed a core change to allow for extending instance and code TTL with separate values on the host environment to allow for more cost-efficient designs Proposal.
...
- [Tommaso on Discord](https://discord.com/users/905908451446779965)
