...
2. Learn more in the [proposal](https://github.com/stellar/stellar-protocol/discussions/1499) and [implementation](https://github.com/kalepail/passkey-kit/blob/main/contracts/webauthn-wallet/src/lib.rs)
