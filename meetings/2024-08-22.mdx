...
1. The proposal to add a constructor to the Rust Soroban variant was introduced in a previous protocol meeting ([prior meeting](./2024-07-25.mdx)), documented in CAP-58. A constructor is a function that only runs the first time a contract is created.
