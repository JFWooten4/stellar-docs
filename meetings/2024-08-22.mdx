...
1. The proposal to add a constructor to the Rust Soroban variant was introduced in a previous protocol meeting, documented in CAP-58. A constructor is a function that only runs the first time a contract is created.
...
3. Graydon discussed the Wasmi VM update, documented in CAP-60. Wasmi translates WebAssembly to an Internal Representation (IR) and then executes it. The update has two impacts:
...
4. Jay discussed adding the BLS12-381 cryptographic curve, documented in CAP-59.
...
- [Prior meeting: CAP-58 constructors](./2024-07-25.mdx)
- [CAP-58: Constructors for Soroban contracts](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0058.md)
- [CAP-59: Host functions for BLS12-381](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0059.md)
- [CAP-60: Update to Wasmi register machine](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0060.md)
