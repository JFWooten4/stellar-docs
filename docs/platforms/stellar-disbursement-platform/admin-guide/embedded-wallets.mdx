...
![Creating a disbursement with Embedded Wallet selected](/assets/sdp/43.png)
...
![Invitation to create an embedded wallet with passkey](/assets/sdp/44.png)
...
![Verification prompt after wallet creation](/assets/sdp/45.png)
