...
- Payments are made using **[Stellar Asset Contract (SAC)](../../../tokens/stellar-asset-contract.mdx)** transfers to the smart contract address
...
2. The payment uses a **[Stellar Asset Contract (SAC)](../../../tokens/stellar-asset-contract.mdx) transfer** to move funds from the distribution account to the contract wallet
...
- [Stellar Asset Contract (SAC)](../../../tokens/stellar-asset-contract.mdx) - Token standard for Stellar smart contracts
