...
![Creating a disbursement with Embedded Wallet selected](/assets/sdp/48.png)
...
![Invitation to create an embedded wallet with passkey](/assets/sdp/49.png)
...
![Verification prompt after wallet creation](/assets/sdp/50.png)
