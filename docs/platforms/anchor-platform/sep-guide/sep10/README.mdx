...
**Multiple Home Domains**: If you specify multiple `home_domains` (_e.g._, `ap.stellar.org,*.sdp.stellar.org`), you must also set `SEP10_WEB_AUTH_DOMAIN` to specify which domain hosts the authentication endpoint.
