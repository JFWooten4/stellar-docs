...
- **[SEP-1][sep-1]** — [Stellar.toml file serving for service discovery](sep-guide/sep1/README.mdx)
- **[SEP-6][sep-6]** — [Deposit and withdrawal operations](sep-guide/sep6/README.mdx)
- **[SEP-10][sep-10]** — [Web authentication using challenge/response transactions](sep-guide/sep10/README.mdx)
- **[SEP-12][sep-12]** — Customer KYC/AML data management
- **[SEP-24][sep-24]** — [Interactive deposit and withdrawal flows](sep-guide/sep24/README.mdx)
- **[SEP-31][sep-31]** — [Cross-border payment processing (receive only)](sep-guide/sep31/integration.mdx)
- **[SEP-38][sep-38]** — Price quotes and exchange rate services
- **[SEP-45][sep-45]** — [Web authentication using challenge/responses for contract accounts](sep-guide/sep45/README.mdx)
