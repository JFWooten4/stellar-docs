...
![Lab Horizon Lab Screenshot](/assets/lab/horizon/horizon-endpoints.png)
...
![Lab Horizon Docs](/assets/lab/horizon/horizon-view-docs.png)
...
![Lab Horizon Payments](/assets/lab/horizon/horizon-payments.png)
...
![Lab Horizon Payments Response](/assets/lab/horizon/horizon-payments-response.png)
...
![Lab Horizon Assets](/assets/lab/horizon/horizon-assets.png)
...
![Lab Horizon Assets](/assets/lab/horizon/horizon-assets-usdc.png)

When I click the **Submit** button, the `/assets` endpoint returns the `USDC` asset details in `JSON` format.

![Lab Horizon Assets](/assets/lab/horizon/horizon-assets-usdc-response.png)
...
![Lab Horizon Share Feature](/assets/lab/horizon/horizon-share.png)
...
![Lab Horizon Save](/assets/lab/horizon/horizon-save.png)
