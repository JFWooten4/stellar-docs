...
Axelar has created a Rust crate with useful macros for Stellar smart contract development. Learn more about its attribute and derive macros in the [`stellar_axelar_std_derive` Rust crate documentation](https://axelarnetwork.github.io/axelar-amplifier-stellar/stellar_axelar_std_derive/index.html).
