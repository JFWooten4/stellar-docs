...
| total_tvl_usd | The total value locked (TVL) denominated in USD for a given date. Aggregated across relevant ledger entries (_e.g._, accounts, trustlines). | float |  | Yes |  |
