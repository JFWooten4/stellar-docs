...
| `INSUFFICIENT_BALANCE` | -7 | Fee would bring account below minimum balance; learn more in the [Lumens section](../../../../../learn/fundamentals/lumens.mdx#minimum-balance) |
| `NO_ACCOUNT` | -8 | Source account not found |
| `INSUFFICIENT_FEE` | -9 | Fee is too small; learn more in the [Fees section](../../../../../learn/fundamentals/fees-resource-limits-metering.mdx) |
...
Learn more about minimum balances in the [Lumens section](../../../../../learn/fundamentals/lumens.mdx#minimum-balance).
