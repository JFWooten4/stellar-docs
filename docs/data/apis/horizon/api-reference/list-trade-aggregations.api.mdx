...
description: "This endpoint displays [trade](../../../../learn/fundamentals/liquidity-on-stellar-sdex-liquidity-pools.mdx#orders) data based on filters set in the arguments."
