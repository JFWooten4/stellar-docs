...
- Captures token movements resulting from:
  ...
  - Clawback operations
  - [Stellar Asset Contract](../../../../../tokens/stellar-asset-contract.mdx) events
...
| `contractAddress` | `string` | The contract address associated with the asset/token being moved. For classic operations or [Stellar Asset Contract](../../../../../tokens/stellar-asset-contract.mdx) events, this field will be the contractId of the underlying classic asset. This enables integration with Stellar's smart contract ecosystem. |
