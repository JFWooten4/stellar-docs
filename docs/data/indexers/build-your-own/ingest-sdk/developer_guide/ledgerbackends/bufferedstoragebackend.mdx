...
- **XDR Output**: Returns ledger metadata in XDR format, enabling easy integration with other packages in ingest SDK (_e.g._, [processors](https://github.com/stellar/go-stellar-sdk/tree/main/processors)).
