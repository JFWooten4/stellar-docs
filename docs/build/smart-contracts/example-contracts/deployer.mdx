...
Learn more in the [tests](#tests) for an example of uploading the contract code programmatically. Learn more about the actual on-chain installation in the general [deployment tutorial](../../smart-contracts/getting-started/deploy-to-testnet.mdx).
...
Learn more about the actual authorization payloads in the [tests](#tests).
