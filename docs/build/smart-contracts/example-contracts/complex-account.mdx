...
- [Delegate Auth example](./delegate-auth.mdx) — extends this example with [CAP-71](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0071.md) auth delegation to registered delegate signers.
