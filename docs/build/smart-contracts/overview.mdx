...
<details>
  ...
  (clawback, set_auth) on the built-in [Stellar Asset
  Contract](../../tokens/stellar-asset-contract.mdx).
</details>
...
<details>
  ...
  [Stellar Asset Contract](../../tokens/stellar-asset-contract.mdx) is built
  into the host. Read more in the [Tokens
