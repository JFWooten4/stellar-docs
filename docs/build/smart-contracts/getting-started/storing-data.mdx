...
This is going to follow along with the [increment example](https://github.com/stellar/soroban-examples/tree/v22.0.1/increment), which has a single function that increments an internal counter and returns the value. Explore a working example by [trying it in Devcontainers](https://github.com/codespaces/new?repo=stellar/soroban-examples&editor=web).
