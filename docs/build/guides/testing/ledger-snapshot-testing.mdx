...
The deploy command will return the contract’s address (_e.g._, `CB5QCALXDP2N6H473AQBNIFEAPCNHWCIWOASRNGTHCSC4WNC3SOROBAN`), which will be used in the following steps.
