...
The `quickstart.sh` script sets up the Docker environment for running the dapp. It allows you to choose between a standalone network or Futurenet. The script performs the following steps:
