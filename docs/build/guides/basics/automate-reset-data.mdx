...
Stellar operates two primary testing environments: [Testnet and Futurenet](../../../networks/README.mdx). These networks allow developers to experiment with Stellar features without risking real assets. Periodically, these networks are reset to ensure they remain clean and manageable.

## What is a Testnet or Futurenet reset?
...
Generates a new Stellar keypair (public and secret keys). Uses FriendBot to fund the new account on Testnet. Returns the created keypair.
