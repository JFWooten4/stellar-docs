...
For instance, if you use events for bookkeeping purposes on a payment application, processing twice the same event could result in a [double spend](../../../learn/glossary.mdx#double-spend-attack). In such cases, you will want your system to be idempotent to guarantee that this scenario would be covered.
