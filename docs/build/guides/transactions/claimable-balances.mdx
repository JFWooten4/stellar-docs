...
Each ClaimableBalanceEntry is a ledger entry, and each claimant in that entry increases the source account’s minimum balance by one [base reserve](../../../learn/fundamentals/lumens.mdx#base-reserves).
