...
To monitor these payments, the method '[getEvents](../../../data/apis/rpc/api-reference/methods/getEvents.mdx)' of the Stellar RPC is used to stream events emitted by the [Stellar Asset Contract](../../../tokens/stellar-asset-contract.mdx). A filter can be used to specify the target asset (SAC contract ID) and accounts.
