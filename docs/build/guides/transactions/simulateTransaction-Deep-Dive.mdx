...
Stellar Development Foundation provides a Testnet RPC service at `http://soroban-testnet.stellar.org`. For Mainnet providers, refer to the [Ecosystem RPC Providers](../../../data/apis/rpc/providers.mdx) list.
