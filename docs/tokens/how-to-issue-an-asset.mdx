...
In this tutorial, we will walk through the steps to issue an asset on Stellar Testnet.
...
# To use Mainnet, set the hostname to horizon_url for Mainnet.
server = Server(horizon_url="https://horizon-testnet.stellar.org")
# Use Testnet. To use Mainnet, set this to `Network.PUBLIC_NETWORK_PASSPHRASE`.
network_passphrase = Network.TESTNET_NETWORK_PASSPHRASE
