...
- `CLAWBACK_ENABLED`: enables the issuing account to take back (burning) all of the asset. Learn more in our [Clawbacks section](../build/guides/transactions/clawbacks.mdx).
...
Learn more in the optional steps of the [Issuing an Asset tutorial](./how-to-issue-an-asset.mdx#configure-maximum-supply).
