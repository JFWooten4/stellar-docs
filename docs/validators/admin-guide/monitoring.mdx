...
The table below summarizes the most important fields to check at a glance. Learn more in the explanations above and the [quorum health section](#quorum-health) below.
