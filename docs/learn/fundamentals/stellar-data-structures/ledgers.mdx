...
The maximum number of operations validators have agreed to process in a given ledger. If more transactions are submitted than this number, the network will enter into surge pricing mode. Learn more about surge pricing and fee strategies in our [Fees section](../../fundamentals/fees-resource-limits-metering.mdx).
