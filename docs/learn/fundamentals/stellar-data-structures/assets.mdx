...
"Classic" assets issued by Stellar accounts (`G...` addresses) and their built-in [Stellar Asset Contract (SAC)](../../../tokens/stellar-asset-contract.mdx) implementation, and contract tokens issued by a deployed Wasm contract (`C...` addresses).
...
Assets issued on the Stellar network are accessible to smart contracts. Every Stellar asset has reserved a [Stellar Asset Contract (SAC)](../../../tokens/stellar-asset-contract.mdx) that can be deployed by anyone who wants to be able to interact with the asset from a contract.

The Stellar CLI can deploy a [Stellar Asset Contract](../../../tokens/stellar-asset-contract.mdx) for a Stellar asset. Deploying the [Stellar Asset Contract](../../../tokens/stellar-asset-contract.mdx) for a Stellar asset enables that asset for use with smart contracts.
