...
The `OfferEntry` represents an offer made on the SDEX orderbook. See [Liquidity on Stellar](../../liquidity-on-stellar-sdex-liquidity-pools.mdx#orderbook) DEX section.
