...
In this section, we will talk about the SDEX and liquidity pools. Learn more about how these work together to execute transactions in our [Path Payments guide](../../build/guides/transactions/path-payments.mdx).
...
Learn more about transaction fees in our [Fees section](./fees-resource-limits-metering.mdx).
