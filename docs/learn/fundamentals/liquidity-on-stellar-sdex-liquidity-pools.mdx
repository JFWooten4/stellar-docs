...
An orderbook is a record of outstanding orders on a network, and each record sits between two assets. The order book for this asset pair records every account wanting to sell wheat for sheep and every account wanting to sell sheep for wheat.
