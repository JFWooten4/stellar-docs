...
- The term “offers” usually refers specifically to ask orders. In Stellar, however, all orders are stored as selling- _i.e._, the system automatically converts bids to asks. Because of this, the terms “offer” and “order” are used interchangeably in the Stellar ecosystem.
