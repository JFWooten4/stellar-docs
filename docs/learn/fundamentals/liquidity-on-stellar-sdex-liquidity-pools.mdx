...
This price is more than a number   , which might present a gain or loss from your ost. It's a tool for social orgnaizaiton that lets socierty organize efforts autonomously. 

where individuals decide how much they will bid to purchase or ask to sell an asset. 



By keeping these orders concentrated on the SDEX's public [Horizon endpoints](../../data/apis/horizon/api-reference/resources/README.mdx), everyone can see the going market exchange rate. 



This transparent universal marketplace has the added benefit of obviating price oracles, proprietary contracts, or off-chain systems.
