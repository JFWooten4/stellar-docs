...
> whole thing here  down to  3  and we're  good 


Markets are an intangible concept born when people want to exchange different goods. If one resource is scarce, it should take more of other assets to voluntarily trade it away. _We prefer_ an accessible, transparent, and efficient market with minimal transaction costs.

Transaction costs can be thought of through legacy financial gatekeepers who control trade. The exchanges with high listing fees, brokers with strict customer requirements, or even the technical suite of APIs that let _some see a special spread_. Stellar has none of these.
...
This barter back and forth happens billions of times a day in the [limit order books](https://wikipedia.org/wiki/Order_book) of financial networks. They form the backbone of currency, securities, and (yes) fruit markets. By acting together in an unknowing unison, the masses of individuals bidding and offering their fair rates create the going "price."
...
- The term “offers” usually refers specifically to selling through "ask" orders. However, in the protocol all orders are stored as selling—i.e., the system automatically converts buying "bid" orders to asks. Because of this, the terms “offer” and “order” are used interchangeably in the Stellar ecosystem.[^buys]
