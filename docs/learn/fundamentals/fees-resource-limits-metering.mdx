...
Learn more about analyzing smart contract cost and efficiency in the [Analyzing Smart Contract Cost guide](../../build/guides/fees/analyzing-smart-contract-cost.mdx).
