...
Below are the general descriptions of these implementations. Learn more about how different accounts are represented in the [Stellar Transaction guide](../contract-development/contract-interactions/stellar-transaction.mdx).
...
This supports the Stellar multisig with medium threshold. Learn more about multisig and thresholds in the [Signatures and Multisig section].

[Signatures and Multisig section]: ../transactions/signatures-multisig.mdx
