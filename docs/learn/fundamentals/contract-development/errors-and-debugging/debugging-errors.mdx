...
Errors here are returned by the host and propagated through RPC. This doesn’t cover other possible errors (_e.g._ network errors, errors in RPC itself etc.)
