...
[xdr]: https://github.com/stellar/stellar-xdr/blob/curr/Stellar-transaction.x#L521-L531
...
3. `HOST_FUNCTION_TYPE_CREATE_CONTRACT`
   ...
   - `contractIDPreimage` is defined as following:
     ...
     [`hashidpreimage`]: https://github.com/stellar/stellar-xdr/blob/curr/Stellar-transaction.x#L721-L760
...
[envelope-xdr]: https://github.com/stellar/stellar-xdr/blob/curr/Stellar-transaction.x#L721-L760
...
[extension]: https://github.com/stellar/stellar-xdr/blob/curr/Stellar-transaction.x#L880-L900
