...
There are many SEPs, and they cover a wide variety of standards for interoperation (learn more in the [complete list of active SEPs below](#complete-list-of-active-proposals)). Whatever you're building, you may want to take a look at the complete list to see if there's a standard for your use case.
