...
description: Learn how operation source accounts can differ from a transaction source account and affect required signatures.
sidebar_label: Unique Source Accounts for Operations
sidebar_position: 40
---

<!-- PR #2703 references this page from the "Background Motivation" section: https://github.com/stellar/stellar-docs/pull/2703 -->
