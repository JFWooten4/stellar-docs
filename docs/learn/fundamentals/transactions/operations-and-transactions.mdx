...
Learn more about muxed accounts in our [Pooled Accounts - Muxed Accounts & Memos guide](../../../build/guides/transactions/pooled-accounts-muxed-accounts-memos.mdx).
...
Learn more about fee-bump transaction validity in the [Fee-Bump Transactions guide](../../../build/guides/transactions/fee-bump-transactions.mdx).
